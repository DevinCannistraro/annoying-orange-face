...
def do_PIL_processing(mouth_path,left_eye_path,right_eye_path):
    ...
    mouth_im = anti_alias_resize_path(mouth_im,2,"mouth_resize")
    left_eye_im = anti_alias_resize_path(left_eye_im, 2, "left_resize")
    right_eye_im = anti_alias_resize_path(right_eye_im, 2, "right_resize")
